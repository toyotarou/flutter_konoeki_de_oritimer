...
abstract class $TokyoTrainStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Map<String, List<TokyoTrainModel>> tokyoStationTokyoTrainModelListMap});
}
...
class _$TokyoTrainStateCopyWithImpl<$Res, $Val extends TokyoTrainState>
  ...
  $Res call({
    ...
    Object? tokyoStationTokyoTrainModelListMap = null,
  }) {
    return _then(_value.copyWith(
      ...
      tokyoStationTokyoTrainModelListMap: null ==
              tokyoStationTokyoTrainModelListMap
          ? _value.tokyoStationTokyoTrainModelListMap
          : tokyoStationTokyoTrainModelListMap // ignore: cast_nullable_to_non_nullable
...
class __$$TokyoTrainStateImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$TokyoTrainStateImpl(
      ...
      tokyoStationTokyoTrainModelListMap: null ==
              tokyoStationTokyoTrainModelListMap
          ? _value._tokyoStationTokyoTrainModelListMap
          : tokyoStationTokyoTrainModelListMap // ignore: cast_nullable_to_non_nullable
              as Map<String, List<TokyoTrainModel>>,
    ));
  }
...
class _$TokyoTrainStateImpl implements _TokyoTrainState {
  const _$TokyoTrainStateImpl(
      ...
      : _tokyoTrainList = tokyoTrainList,
        ...
        _tokyoStationTokyoTrainModelListMap =
            tokyoStationTokyoTrainModelListMap;
  ...
  final Map<String, List<TokyoTrainModel>> _tokyoStationTokyoTrainModelListMap;
  @override
  @JsonKey()
  Map<String, List<TokyoTrainModel>> get tokyoStationTokyoTrainModelListMap {
    if (_tokyoStationTokyoTrainModelListMap is EqualUnmodifiableMapView)
      return _tokyoStationTokyoTrainModelListMap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_tokyoStationTokyoTrainModelListMap);
  }

  @override
  String toString() {
    return 'TokyoTrainState(tokyoTrainList: $tokyoTrainList, tokyoTrainMap: $tokyoTrainMap, tokyoStationTokyoTrainModelListMap: $tokyoStationTokyoTrainModelListMap)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other._tokyoStationTokyoTrainModelListMap,
                _tokyoStationTokyoTrainModelListMap));
  }
...
abstract class _TokyoTrainState implements TokyoTrainState {
  const factory _TokyoTrainState(
      ...
      final Map<String, List<TokyoTrainModel>>
          tokyoStationTokyoTrainModelListMap}) = _$TokyoTrainStateImpl;
